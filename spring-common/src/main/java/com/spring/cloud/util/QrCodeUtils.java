...
public class QrCodeUtils {
    ...
    // 二维码尺寸
    private static final int QRCODE_SIZE = 41;
    // LOGO宽度
    ...
    private static void insertImage(BufferedImage source, String logoPath, boolean needCompress) throws IOException {
        ...
        try {
//            BufferedImage b= new PictureUtils().getRemoteBufferedImage(logoPath);
//            inputStream = FileUtils.getResourceAsStream(logoPath);
            Image src = new PictureUtils().getRemoteBufferedImage(logoPath);
